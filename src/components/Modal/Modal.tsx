...
import {MappedModalBody} from "../Map/MappedModalBody";
            ...
            {modal &&
                <div className={modal ? 'modal modal__active' : 'modal'} onClick={() => setModalNotes(false)}>
                    <div className="modal__container" onClick={(e: MouseEvent<HTMLDivElement>) => e.stopPropagation()}>
                        ...
                        <p className="modal__body" style={{opacity: modalNote[0].completed ? 0.5 : 1,textDecoration: modalNote[0].completed ? 'line-through' : 'none'}}>
                            <MappedModalBody />
                        </p>
